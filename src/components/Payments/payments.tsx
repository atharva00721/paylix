  ...
  return (
    <section className="w-full flex flex-col items-center justify-center py-12 md:py-24 px-2 md:px-4">
      ...
      <h1 className="text-center text-3xl md:text-5xl text-gray-900 mb-4">
        End-to-end universal payment solution for{" "}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 ">
          ...
          <div className="bg-background border border-border rounded-xl min-h-[300px] md:h-[500px] flex flex-col relative overflow-hidden">
            <div className="p-8 pb-2 ">
              ...
              <p className="text-muted-foreground">
                A Snapshot of Recent Crypto Wallet Transactions.
              </p>
            </div>
            <img
              src="/payments/payouts.png"
              alt="Payouts"
          ...
          <div className="bg-background border border-border rounded-xl min-h-[300px] md:h-[500px] flex flex-col relative overflow-hidden">
            <div className="p-8 ">
              ...
              <p className="text-muted-foreground">
                Sell globally with PayPal, Stripe, CashApp, and multiple other
                popular gateways.
              </p>
            </div>
            <div className="bg-[url('/payments/mapbase.svg')] mt-2 bg-cover bg-center">
              <img
                src="/payments/Logos.png"
                alt="Payouts"
                className="w-full h-auto mt-8 select-none pointer-events-none object-contain"
              />
            </div>
          </div>
          {/* Fees Card */}
          <div className="bg-background border border-border rounded-xl min-h-[300px] md:h-[500px] flex flex-col relative overflow-hidden">
            <div className="p-8">
              ...
              <p className="text-muted-foreground">
                Unlike other popular platforms, Paylix takes the lowest fees in
                comparison — by a longshot.
              </p>
            </div>
            <img
              src="/payments/Fees.png"
              alt="Payouts"
              className="w-full h-auto mt-8 select-none pointer-events-none object-contain"
            />
            <div className="absolute w-[720px] h-[100px] left-[calc(50%-360px)] bottom-[-37px] bg-white blur-[25px] pointer-events-none" />
          ...
          <div className="bg-background border border-border rounded-xl min-h-[300px] md:h-[500px] flex flex-col relative overflow-hidden">
            <div className="p-8 pb-2 ">
              <h2 className="text-lg font-semibold mb-2">Payouts</h2>
              <p className="text-muted-foreground">
                Accept in-person payments through your mobile device with zero
                overhead.
              </p>
            </div>

            <img
              src="/payments/Sale.png"
              alt="Payouts"
              className="w-full h-auto mt-8 select-none pointer-events-none object-contain"
            />
          </div>
